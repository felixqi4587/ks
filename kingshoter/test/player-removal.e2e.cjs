...
(async () => {
  ...
  try {
    ...
    assert.equal(await manager.locator('link[href="app.css?v=2026071701"]').count(), 1);
    assert.equal(await manager.locator('script[src="/app.js?v=2026071701"]').count(), 1);
    assert.equal(await manager.locator('script[src="/rally-controller.js?v=2026071701"]').count(), 1);
