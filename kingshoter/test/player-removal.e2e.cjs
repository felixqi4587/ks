...
(async () => {
  ...
  try {
    ...
    assert.equal(await manager.locator('link[href="app.css?v=2026071603"]').count(), 1);
    assert.equal(await manager.locator('script[src="/app.js?v=2026071603"]').count(), 1);
    assert.equal(await manager.locator('script[src="/kvk.js?v=2026071603"]').count(), 1);
