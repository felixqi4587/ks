...
(async () => {
  ...
  try {
    ...
    assert.equal(await page.locator('link[href="app.css?v=2026071302"]').count(), 1);
    assert.equal(await page.locator('script[src="/app.js?v=2026071302"]').count(), 1);
    assert.equal(await page.locator('script[src="/kvk.js?v=2026071302"]').count(), 1);
