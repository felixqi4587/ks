...
test('KvK cache versions move atomically with the delivery client and styles', () => {
  assert.match(html, /app\.css\?v=2026071507/);
  assert.match(html, /kvk-update\.js\?v=2026071507/);
  assert.match(html, /app\.js\?v=2026071507/);
  assert.match(html, /kvk-delivery-shadow\.js\?v=2026071507/);
  assert.match(html, /kvk-rally\.js\?v=2026071507/);
  assert.match(html, /kvk\.js\?v=2026071507/);
});
